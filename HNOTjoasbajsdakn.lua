if game.PlaceId == 6284583030 or game.PlaceId == 7722306047 then
    ...
    for i,v in pairs(Library.Save.Get().Pets) do
         if v.uid == uid and getgenv().TrackListHatchNotify[PettoRarity[v.id]] then
             ...
             local Color = (Rarity == 'Exclusive') or (Rarity == 'Mythical' and "ff8c00") or (Rarity == 'Legendary' and "ff45f6") or (Rarity == 'Epic' and "ffea47") or (Rarity == 'Rare' and "42ff5e") or (Rarity == 'Basic' and "b0b0b0")
             local NewPowers = {}
